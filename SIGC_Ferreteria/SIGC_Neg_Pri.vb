        ...
        Select Case e.Tool.Key
            Case "Clientes"
                ...
                If Me.tabOpc.TabPages(key) Is Nothing Then
                    Dim f As New SIGC_Neg_Cat_frmClte
                    f.Text = "Clientes" '
            ...
            Case "Artículos"
                ...
                ' Valida si el formulario ya se encuentra abierto
                If Me.tabOpc.TabPages(key) Is Nothing Then
                    Dim f As New SIGC_Neg_Cat_frmProd
                    f.Text = "Artículos" '
                    'Crea el tab que lo contiene
                    Me.tabOpc.TabPages.Add(key, f.Text)
                    f.TopLevel = False
            ...
            Case "Marcas"
                ...
                ' Valida si el formulario ya se encuentra abierto
                If Me.tabOpc.TabPages(key) Is Nothing Then
                    Dim f As New SIGC_Neg_Tab_frmMarca
                    f.Text = "Marcas" '
                    'Crea el tab que lo contiene
                    Me.tabOpc.TabPages.Add(key, f.Text)
                    f.TopLevel = False
            ...
            Case "Proveedores"
                ...
                ' Valida si el formulario ya se encuentra abierto
                If Me.tabOpc.TabPages(key) Is Nothing Then
                    Dim f As New SIGC_Neg_Cat_frmProv
                    f.Text = "Proveedor" '
                    'Crea el tab que lo contiene
                    Me.tabOpc.TabPages.Add(key, f.Text)
                    f.TopLevel = False
            ...
            Case "Categoria"
                ...
                ' Valida si el formulario ya se encuentra abierto
                If Me.tabOpc.TabPages(key) Is Nothing Then
                    Dim f As New SIGC_Neg_Tab_frmCateg
                    f.Text = "Categoría" '
                    'Crea el tab que lo contiene
                    Me.tabOpc.TabPages.Add(key, f.Text)
                    f.TopLevel = False
            ...
            Case "Estados"
                ...
                ' Valida si el formulario ya se encuentra abierto
                If Me.tabOpc.TabPages(key) Is Nothing Then
                    Dim f As New SIGC_Neg_Tab_frmEstados
                    f.Text = "Estados" '
                    'Crea el tab que lo contiene
                    Me.tabOpc.TabPages.Add(key, f.Text)
                    f.TopLevel = False
