Imports SIGC_FerBL
Public Class SIGC_Fer_Tab_frmUniMed
    ...
    Private Sub SIGC_Fer_Tab_frmUniMed_Load(sender As Object, e As EventArgs) Handles Me.Load
        mbCargar = False
    ...
    Private Sub LlenarGrilla()
        Try
            ...
            dt = BL.fListarTablaUniMed(GS_EMP_ID)
            BL = Nothing
        ...
        If Not Me.grdDat.ActiveRow Is Nothing Then
            If Not Me.grdDat.ActiveRow.IsGroupByRow Then
                If Not Me.grdDat.ActiveRow.IsFilterRow Then
                    Me.txtId.Text = Me.grdDat.ActiveRow.Cells("UNIMED_ID").Value.ToString
                    Me.txtDes.Text = Me.grdDat.ActiveRow.Cells("UNIMED_DESC").Value.ToString
                    If Me.grdDat.ActiveRow.Cells("UNIMED_EST").Value.ToString = "A" Then
    ...
    Private Sub Pinta_InfraGrilla()
        With Me.grdDat
            ...
            ConfiguraColGrilla(Me.grdDat, 1, "Id.UM", 50, True, False, False)
...
#Region "ToolBar"
    ...
    Private Sub GrabarToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GrabarToolStripMenuItem.Click
        ...
        Try
            ...
            ' Nuevo
            If Nuevo Then
                loRes = BL.fManTabUniMed(GS_OPC_ADD, lnId, GS_EMP_ID, txtDes.Text, lsEst)
            End If

            ' Modificar
            If Editando Then
                lnId = grdDat.ActiveRow.Cells("UNIMED_ID").Value.ToString
                loRes = BL.fManTabUniMed(GS_OPC_MOD, lnId, GS_EMP_ID, txtDes.Text, lsEst)
            End If

            If Eliminando Then
                lnId = grdDat.ActiveRow.Cells("UNIMED_ID").Value.ToString
                lsEst = "I"
                loRes = BL.fManTabUniMed(GS_OPC_DEL, lnId, GS_EMP_ID, txtDes.Text, lsEst)
            End If
